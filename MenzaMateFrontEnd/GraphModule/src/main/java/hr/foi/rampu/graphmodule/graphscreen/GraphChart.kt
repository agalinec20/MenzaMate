...
@Composable
fun GraphChart(distribution: Map<Int, Int>) {
    val sortedResponses = (1..5).associateWith { distribution[it] ?: 0 }
    val maxCount = sortedResponses.values.maxOrNull() ?: 1
    ...
    Card(
        ...
        Column(
            ...
            Canvas(
                ...
                val barWidth = size.width / (sortedResponses.size * 3)
                val spacing = barWidth
                var xOffset = spacing
                sortedResponses.forEach { (rating, count) ->
